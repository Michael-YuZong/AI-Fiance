"""Audit round-based review records for protocol and solidification quality."""

from __future__ import annotations

import argparse

from src.reporting.review_audit import build_review_audit, render_review_audit_json, render_review_audit_markdown
