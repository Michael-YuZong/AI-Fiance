...
MODEL_VERSION = "stock-pick-2026-03-11-catalyst-sanity-v4"
MODEL_CHANGELOG = [
...
def main() -> None:
    ...
    payload = enrich_payload_with_score_history(payload, market=args.market, sector_filter=args.sector.strip())
